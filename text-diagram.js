 ...
 *
 * Author: weidagang@gmail.com, timfanda35@gmail.com
 */
 ...
 * 3) convert image objects to TEXT;
 */
function sequence_diagram(in_src) {
  ...
  var cimage = text_render.to_cimage(ast);
  var text = text_render.to_text(cimage);
  return text;
};
...
var text_render = (function() {
  ...
  // convert ccanvas to text
  function _to_text(in_m) {
    var text = "";
...
exports.sequence_diagram = sequence_diagram;
